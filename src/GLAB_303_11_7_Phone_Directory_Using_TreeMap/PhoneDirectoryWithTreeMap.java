package GLAB_303_11_7_Phone_Directory_Using_TreeMap;
...
/**
 * Objective
 * In this lab, we will create a basic PhoneDirectory by using a TreeMap to
 * store directory entries.
 * Learning Objective:
 * By the end of this lesson, learners will be able to utiliZe the TreeMap.
 * Scenario
 * ● Finds the phone number, if any, for a given name and returns the
 * phone number associated with the name if the name does not
 * occur in the phone directory, and then returns the value as null.
 * ● Associates a given name with a given phone number. If the name
 * already exists in the phone directory, the new number replaces the
 * old one. Otherwise, a new name/number pair is added. The name
 * and number should both be non-null. An IllegalArgumentException
 * is thrown if this is not the case.
 */
/*
Instructions
Step 1: Create a new Java project and create a new Class named “PhoneDirectoryWithTreeMap,”
 */
...
public void putNumber(String name, String number) {
         if(name == null || number == null) {
             throw new NullPointerException("name or number cannot be null");
         }
